...
func TestPaginateWithFilters(t *testing.T) {
	...
	testPaginationWithFilters(t, listQuery1, DB, m)
	...
	listQuery2 := &pagination.ListQuery{
		...
		OrderBy: "created_at DESC",
		Filters: []*pagination.FilterModel{
			{Field: "first_name", Value: "Alice", Comparison: "starts_with"},
		},
	}
	testPaginationWithFilters(t, listQuery2, DB, m)
	...
	testPaginationWithFilters(t, listQuery3, DB, m)
	...
	testPaginationWithFilters(t, listQuery4, DB, m)
	...
	listQuery5 := &pagination.ListQuery{
		...
		OrderBy: "created_at DESC",
		Filters: []*pagination.FilterModel{
			{Field: "first_name", Value: "John", Comparison: "!="},
		},
	}
	testPaginationWithFilters(t, listQuery5, DB, m)
	...
	testPaginationWithFilters(t, listQuery6, DB, m)
	...
	listQuery7 := &pagination.ListQuery{
		...
		OrderBy: "created_at DESC",
		Filters: []*pagination.FilterModel{
			{Field: "first_name", Value: "Doe", Comparison: "ends_with"},
		},
	}
	testPaginationWithFilters(t, listQuery7, DB, m)
	...
	testPaginationWithFilters(t, listQuery8, DB, m)
	...
	testPaginationWithFilters(t, listQuery9, DB, m)
	...
	testPaginationWithFilters(t, listQuery10, DB, m)
	...
	testPaginationWithFilters(t, listQuery11, DB, m)
	...
	testPaginationWithFilters(t, listQuery12, DB, m)
	...
	testPaginationWithFilters(t, listQuery13, DB, m)
	...
	testPaginationWithFilters(t, listQuery14, DB, m)
	...
	testPaginationWithFilters(t, listQuery15, DB, m)
	...
	testPaginationWithFilters(t, listQuery16, DB, m)
	...
	testPaginationWithFilters(t, listQuery17, DB, m)
	...
	testPaginationWithFilters(t, listQuery18, DB, m)
	...
	testPaginationWithFilters(t, listQuery19, DB, m)
	...
	testPaginationWithFilters(t, listQuery20, DB, m)
	...
	testPaginationWithFilters(t, listQuery21, DB, m)
	...
	testPaginationWithFilters(t, listQuery22, DB, m)
	...
	testPaginationWithFilters(t, listQuery23, DB, m)
}

func testPaginationWithFilters(t *testing.T, listQuery *pagination.ListQuery, DB *gorm.DB, m sqlmock.Sqlmock) {
